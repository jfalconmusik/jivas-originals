...
function Belts() {
  ...
  return (
    <div>
      ...
      >
        <h2 style={{ fontFamily: "Luminari" }}>Belts</h2>
        <br></br>
        {displayNumber && (
          <p
            style={{
            ...
            <div className="column shadowed" style={{ maxHeight: "830px" }}>
              <div className="productCard">
                <div class="img-responsive">
                  <div
                    className="paisley"
                    id={`contentLoader${belts.indexOf(item[0])}`}
                  ...
                  >
                    ...
                    <div
                      ...
                      id={`spinner${belts.indexOf(item[0])}`}
                    ></div>
                  </div>
                  <div
                    onMouseOver={() => {
                    ...
                    <Link to={`/product/${productPageLinkString}`}>
                      <img
                        ...
                        onLoad={() => {
                          ...
                          document.getElementById(
                            `contentLoader${belts.indexOf(item[0])}`
                          ).style.display = "none";
