    ...
    <div>
      <nav className="darkNav" aria-label="You are here:" role="navigation">
        <ul class="breadcrumbs">
          ...
          <li>
            <Link to="/shop/cloaks">Cloaks</Link>
          </li>
          <li>
            <span class="show-for-sr">Current: Cloaks</span>
          </li>
        </ul>
      </nav>
      <div
      ...
      >
        <h2 style={{ fontFamily: "Luminari" }}>Cloaks</h2>
        <br></br>
        {displayNumber && (
          <p
            style={{
            ...
            <div className="column shadowed" style={{ maxHeight: "830px" }}>
              <div className="productCard">
                <div class="img-responsive">
                  <div
                    className="paisley"
                    id={`contentLoader${cloaks.indexOf(item[0])}`}
                  ...
                  >
                    ...
                    <div
                      ...
                      id={`spinner${cloaks.indexOf(item[0])}`}
                    ></div>
                  </div>
                  <div
                    className="tops"
                    ...
                    <Link to={`/product/${productPageLinkString}`}>
                      <img
                        ...
                        onLoad={() => {
                          ...
                          document.getElementById(
                            `contentLoader${cloaks.indexOf(item[0])}`
                          ).style.display = "none";
