                            ...
                            <div className="itemCard">
                                ...
                                {(productColorNameHex.length > 1) &&
                                    <div className="row">
                                        ...
                                        <br></br>
                                        <h4 className="column">{colorName}</h4>
                                    </div>
                                }
                                {(!productSize.includes("One-Size")) && <h4>{productSize}</h4>}
                                <h2>Quantity: {productQuant}</h2>
                                <select id={`quantityChosen${productNameLink}`}
                                    onChange={() => {
                                        handleQuantChoice(
                                            `${item[0]}`,
                                            `${productFullColor}`,
                                ...
                                >
                                    ...
                                    {/* <option id={`${productNickName}1`} value="1" >1</option>
                                <option id={`${productNickName}2`} value="2">2</option>
                                <option id={`${productNickName}3`} value="3">3</option>
                                <option id={`${productNickName}4`} value="4">4</option>
                                <option id={`${productNickName}5`} value="5">5</option>
                                <option id={`${productNickName}6`} value="6">6</option>
                                <option id={`${productNickName}7`} value="7">7</option>
                                <option id={`${productNickName}8`} value="8">8</option>
                                <option id={`${productNickName}9`} value="9">9</option>
                            <option id={`${productNickName}10`} value="10">10</option> */}
