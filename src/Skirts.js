    ...
    <div>
      <nav className="darkNav" aria-label="You are here:" role="navigation">
        <ul class="breadcrumbs">
          ...
          <li>
            <Link to="/shop/skirts">Skirts</Link>
          </li>
          <li>
          ...
          return (
            <div className="column shadowed" style={{ maxHeight: "830px" }}>
              <div className="productCard">
                <div
                  className="skirtsCounter"
                  id={`skirts_${Number(skirtCategory.indexOf(item)) + 1}`}
                >
                  <div
                    id={`contentLoader${skirts.indexOf(item[0])}`}
                    ...
                    <Link to={`/product/${productPageLinkString}`}>
                      <img
                        ...
                        onLoad={() => {
                          ...
                          document.getElementById(
                            `contentLoader${skirts.indexOf(item[0])}`
                          ).style.display = "none";
