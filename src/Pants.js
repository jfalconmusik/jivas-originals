    ...
    <div>
      <nav className="darkNav" aria-label="You are here:" role="navigation">
        <ul class="breadcrumbs">
          ...
          <li>
            <span class="show-for-sr">Current: Pants</span>
          </li>
        </ul>
      </nav>
      <div
      ...
      >
        <h2 style={{ fontFamily: "Luminari" }}>Pants</h2>
        <br></br>
        {displayNumber && (
          <p
            style={{
            ...
            <div className="column shadowed" style={{ maxHeight: "830px" }}>
              <div className="productCard">
                <div class="img-responsive">
                  <div
                    className="paisley"
                    id={`contentLoader${pants.indexOf(item[0])}`}
                  ...
                  >
                    ...
                    <div
                      ...
                      id={`spinner${pants.indexOf(item[0])}`}
                    ></div>
                  </div>
                  <div
                    className="tops"
                    ...
                    <Link to={`/product/${productPageLinkString}`}>
                      <img
                        ...
                        onLoad={() => {
                          ...
                          document.getElementById(
                            `contentLoader${pants.indexOf(item[0])}`
                          ).style.display = "none";
