...
exports.createPaymentIntent = functions.app.post("/create-payment-intent", async (req, res) => {
...
exports.sendWebhook = functions.app.post("/webhook", async (req, res) => {
    let data, eventType;
...
exports.stripeListen = functions.app.listen(4242, () => console.log(`Node server listening on port ${4242}!`));
...
exports.aTesterFunction = functions.https.onRequest((request, response) => {
    response.send("I'm not sure computers actually work.")
})
