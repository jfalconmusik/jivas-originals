...
function TermsOfService() {
    ...
    return (
        <div>
            <h1>Jiva Fashions Terms and Conditions</h1>
            <br></br>
            <p>1. Introduction</p>
            <br></br>
            ...
            under these Terms, Jiva Fashions and/or its licensors own all rights to the
            ...
            Jiva Fashions may further restrict access by you to any areas of this
            ...
            <p>4. No warranties</p>
            <br></br>
            <p>This Website is provided “as is,” with all faults, and Jiva Fashions makes no
            ...
            <br></br>
            <p>In no event shall Jiva Fashions, nor any of its officers, directors and employees,
            ...
            Jiva Fashions, including its officers, directors and employees shall not be liable
            ...
            <br></br>
            <p>You hereby indemnify to the fullest extent Jiva Fashions from and against any
            ...
            <br></br>
            <p>Jiva Fashions is permitted to revise these Terms at any time as it sees fit, and
            ...
            <p>9. Assignment</p>
            <br></br>
            <p>Jiva Fashions shall be permitted to assign, transfer, and subcontract its rights
            ...
            Website, constitute the entire agreement between Jiva Fashions and you in
